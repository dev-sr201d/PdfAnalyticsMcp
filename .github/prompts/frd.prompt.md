...
For each feature you identify, create a file in `specs\features` folder, with the feature name as the filename, prefixed with a sequential number (e.g., `001-feature-xyz.md`).

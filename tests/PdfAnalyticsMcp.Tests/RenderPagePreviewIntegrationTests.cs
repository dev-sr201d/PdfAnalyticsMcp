...
public class RenderPagePreviewIntegrationTests : IDisposable
{
    private readonly Process _serverProcess;
    private readonly StringBuilder _stderrOutput = new();
    private int _requestId;

    public RenderPagePreviewIntegrationTests()
    {
    ...
    private async Task<JsonDocument?> CallToolAsync(string toolName, object arguments)
    {
        ...
        return await ReadResponseAsync(TimeSpan.FromSeconds(30));
    }

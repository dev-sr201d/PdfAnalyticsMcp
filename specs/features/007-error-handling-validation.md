...
| File cannot be opened as a valid PDF | Return error: "The file could not be opened as a PDF." This must apply consistently regardless of which underlying engine (extraction or rendering) is used to open the file. |
